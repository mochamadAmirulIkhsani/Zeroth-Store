...
function Sidebar({
  ...
  return (
    <aside className="space-y-6">
      <div>
        <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Filter Game</p>
        <div className="relative">
          ...
          >
            <span className={selectedGame ? 'text-[#0A0A0A] font-medium' : 'text-gray-500'}>
              {selectedGame ? selectedGame.name : 'Semua Game'}
            </span>
            <ChevronDown className={`w-4 h-4 text-gray-500 transition-transform ${gameDropdownOpen ? 'rotate-180' : ''}`} />
          </button>
          {gameDropdownOpen && (
      ...
      <div>
        <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Filter Bintang</p>
                  ...
                  {paginated.map((t, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {t.service && (
                          <p className="text-gray-500 text-xs mb-3 bg-gray-50 px-2 py-1 rounded-lg inline-block">
                            {t.service}
                          </p>
                        )}
